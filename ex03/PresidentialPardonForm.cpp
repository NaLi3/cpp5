...
/*   Updated: 2025/06/27 18:45:12 by ilevy            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
PresidentialPardonForm::PresidentialPardonForm( const std::string& target ): AForm("PresidentialPardonForm_byTarget", 25, 5), _target( target )
{
	std::cout << BLUE << "Target constructor called for: " << this->getName() \
    << "\nTarget is: " << this->_target \
    << "\nRequired Grade to sign it is: " << this->getSignGrade()\
    << "\nRequired Grade to execute it is: " << this->getExecGrade() << RESET << std::endl;
}
